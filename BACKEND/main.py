...
def call_ollama(prompt):
    """Call Ollama API to analyze prompt and response"""
    try:
...
def analyze_response_quality(prompt, user_response):
    """Analyze the quality of user's analogy response using Ollama (for Game 1)"""
    analysis_prompt = f"""
...
"""
    ...
    llm_response = call_ollama(analysis_prompt)
...
if __name__ == '__main__':
    print("Starting Enhanced Voice Processing API...")
    ...
    try:
        ...
        print("✗ Ollama not accessible - make sure it's running")
